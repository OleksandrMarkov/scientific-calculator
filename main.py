...
font = ('arial', 20, 'bold'), bd = 4, bg = "wheat2",
...
font = ('arial', 20, 'bold'), bd = 4, bg = "wheat2", command = added_value.squared
).grid(row = 1, column = 2, pady = 1))

btnAdd = (Button(calc, text = "+", width = 6, height = 2,
font = ('arial', 20, 'bold'), bd = 4, bg = "wheat2", command = lambda:
...
font = ('arial', 20, 'bold'), bd = 4, bg = "wheat2", command = added_value.mathsPM
...
font = ('arial', 20, 'bold'), bd = 4, bg = "wheat2", command = added_value.pi
).grid(row = 1, column = 4, pady = 1))

btnCos = (Button(calc, text = "cos", width = 6, height = 2,
font = ('arial', 20, 'bold'), bd = 4, bg = "wheat2", command = added_value.cos
).grid(row = 1, column = 5, pady = 1))

btnTan = (Button(calc, text = "tan", width = 6, height = 2,
font = ('arial', 20, 'bold'), bd = 4, bg = "wheat2", command = added_value.tan
).grid(row = 1, column = 6, pady = 1))

btnSin = (Button(calc, text = "sin", width = 6, height = 2,
font = ('arial', 20, 'bold'), bd = 4, bg = "wheat2", command = added_value.sin
).grid(row = 1, column = 7, pady = 1))
# ======================== # ======================== #

btn2Pi = (Button(calc, text = "2π", width = 6, height = 2,
font = ('arial', 20, 'bold'), bd = 4, bg = "wheat2", command = added_value.tau
).grid(row = 2, column = 4, pady = 1))

btnCosh = (Button(calc, text = "cosh", width = 6, height = 2,
font = ('arial', 20, 'bold'), bd = 4, command = added_value.cosh
).grid(row = 2, column = 5, pady = 1))

btnTanh = (Button(calc, text = "tanh", width = 6, height = 2,
font = ('arial', 20, 'bold'), bd = 4, command = added_value.tanh
).grid(row = 2, column = 6, pady = 1))

btnSinh = (Button(calc, text = "sinh", width = 6, height = 2,
font = ('arial', 20, 'bold'), bd = 4, command = added_value.sinh
).grid(row = 2, column = 7, pady = 1))

# ======================== # ======================== #

btnLog = (Button(calc, text = "log", width = 6, height = 2,
font = ('arial', 20, 'bold'), bd = 4, bg = "wheat2", command = added_value.log
).grid(row = 3, column = 4, pady = 1))

btnExp = (Button(calc, text = "Exp", width = 6, height = 2,
font = ('arial', 20, 'bold'), bd = 4, command = added_value.exp
).grid(row = 3, column = 5, pady = 1))

btnMod = (Button(calc, text = "Mod", width = 6, height = 2,
font = ('arial', 20, 'bold'), bd = 4, command = lambda:
added_value.operation("mod")).grid(row = 3, column = 6, pady = 1))

btnE = (Button(calc, text = "e", width = 6, height = 2,
font = ('arial', 20, 'bold'), bd = 4, command = added_value.e
).grid(row = 3, column = 7, pady = 1))

# ======================== # ======================== #

btnLog2 = (Button(calc, text = "log2", width = 6, height = 2,
font = ('arial', 20, 'bold'), bd = 4, bg = "wheat2", command = added_value.log2
).grid(row = 4, column = 4, pady = 1))

btnDeg = (Button(calc, text = "deg", width = 6, height = 2,
font = ('arial', 20, 'bold'), bd = 4, command = added_value.degrees
).grid(row = 4, column = 5, pady = 1))

btnAcosh = (Button(calc, text = "acosh", width = 6, height = 2,
font = ('arial', 20, 'bold'), bd = 4, command = added_value.acosh
).grid(row = 4, column = 6, pady = 1))

btnAsinh = (Button(calc, text = "asinh", width = 6, height = 2,
font = ('arial', 20, 'bold'), bd = 4, command = added_value.asinh
